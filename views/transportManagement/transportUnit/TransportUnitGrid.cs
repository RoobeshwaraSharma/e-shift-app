...
namespace e_shift_app.views.transportManagement.transportUnit
{
    public partial class TransportUnitGrid : Form
    {
        ...
        private void TransportUnitGrid_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error initializing transport units: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void transportUnitGridView_CellEndEdit(object? sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error saving transport unit: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void transportUnitGridView_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error rendering transport unit actions: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void transportUnitGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error handling transport unit action click: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void transportUnitGridView_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error handling mouse move on transport units: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void transportUnitGridView_MouseLeave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"Error handling mouse leave on transport units: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnDownload_Click(object sender, EventArgs e)
        {
            try
            {
                if (transportUnitGridView.Columns.Count == 0 || transportUnitGridView.Rows.Count == 0)
                {
                ...
                using var sfd = new SaveFileDialog()
                {
                    ...
                    FileName = $"transport_units_{DateTime.Now:yyyyMMdd_HHmmss}.csv",
                    Title = "Export Transport Units to CSV"
                };
                ...
                var dataColumns = transportUnitGridView.Columns.Cast<DataGridViewColumn>()
                ...
                foreach (DataGridViewRow row in transportUnitGridView.Rows)
                {
